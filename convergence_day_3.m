function convergence_day_3()
    ...
    for n = 1:num_iter^2
        ...
        if solver_flag == 1
            [x_root, exit_flag, guess] = bisection_solver(@test_func03, x_left(n), x_right(n), dxtol, ftol, max_iter);
...
%             [x_root, exit_flag, guess] = newton_solver(f_record, x0(n), dxtol, ftol, max_iter, dxmax);
% 
%             input_list = my_recorder.get_input_list();
% 
%             if exit_flag == 1 && length(input_list) >= 2
